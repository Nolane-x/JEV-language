...
blocked_items: []
next_tasks:
  - verify M18.1 open-world lexicon/code-switch gate and T098-T106 on CI
...
- M18.1 candidate: Section-209 open-world lexical resolver, EN/VI code-switch evidence, provisional lexical-sense proposals, exact unknown-term preservation and explicit borrowing policy. T098-T106 are implemented pending CI verification.
