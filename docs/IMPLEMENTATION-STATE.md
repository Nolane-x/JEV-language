...
last_completed_gate: M11-synthesis-core
active_milestone: M12-typescript-backend
stable_packages: []
candidate_packages:
  - core-types
  - provenance
